...
$result = mysqli_query($con,"SELECT h.CustomerID, SUM(o.Amount) AS Amount
FROM order_history h JOIN order_product o ON h.OrderID = o.OrderID
WHERE DateAndTime BETWEEN '2019-04-24' AND '2019-05-24'
GROUP BY CustomerID");
...
?>
    ...
    <center>
        <br>
        <h1>This report shows the amount of member purchasing in one month.<span id="name"></span></h1><br>
