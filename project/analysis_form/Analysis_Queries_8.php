...
$con=openCon();
$result = mysqli_query($con,"SELECT s.Group, SUM(o.Amount) AS Amount
...
?>
    ...
    <center>
        <br>
        <h1>This report shows the ratio of product group that were purchased in one month.<span id="name"></span></h1><br>
