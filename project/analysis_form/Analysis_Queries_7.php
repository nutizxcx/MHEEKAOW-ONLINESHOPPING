...
$con=openCon();
$result = mysqli_query($con,"SELECT MONTH(oh.DateAndTime) AS 'Month', SUM(NetTotal) AS Income 
...
?>
    <center>
        <br>
        <h1>This report shows the income that the company receive in each month of the year.<span id="name"></span></h1><br>
        Time: 2018-05-00 To 2019-05-00<span id="name2"></span>
        <table id="customers">
    <thead>
      <tr>
        <th>Month</th>
