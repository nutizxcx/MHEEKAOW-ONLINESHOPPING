...
$con=openCon();
$result = mysqli_query($con,"SELECT s.Category, SUM(o.Amount) AS Amount
FROM skudetail s JOIN order_product o ON s.SKU = o.SKU
JOIN order_history h ON o.OrderID = h.OrderID
WHERE DateAndTime BETWEEN '2019-01-00' AND '2019-02-00'
GROUP BY s.Category");
...
?>
    ...
    <center>
        <br>
        <h1>This report shows the amount of product that were sold in one month separated by category.<span id="name"></span></h1><br>
        Time: 2019-01-00 To 2019-02-00<span id="name2"></span>
