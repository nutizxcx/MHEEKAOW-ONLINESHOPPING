...
$con=openCon();
$result = mysqli_query($con,"SELECT p.Name AS Product, SUM(o.Amount) AS Amount
FROM product_infomation p JOIN order_product o ON p.ProductID = o.ProductID
JOIN order_history h ON o.OrderID = h.OrderID
WHERE h.DateAndTime BETWEEN '2019-01-00' AND '2019-02-00' 
...
<center>
<br>
<h1>This report shows the top 5 best seller products in each month.<span id="name"></span></h1><br>
