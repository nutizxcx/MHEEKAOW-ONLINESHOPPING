...
$con=openCon();
$result = mysqli_query($con,"SELECT oh.CustomerID, COUNT(DISTINCT r.ReturnID) AS Amount
FROM return_request r JOIN order_history oh ON r.OrderID = oh.OrderID 
WHERE r.DateAndTime BETWEEN '2019-04-24' AND '2019-05-24' 
...
?>
    ...
    <center>
        <br>
        <h1>This report shows the times of returning the product in one month.<span id="name"></span></h1><br>
