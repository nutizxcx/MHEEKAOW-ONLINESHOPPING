...
$result = mysqli_query($con,"SELECT MONTH(oh.DateAndTime) AS 'Month', SUM(op.Amount) AS 'Amount'
FROM order_history oh JOIN order_product op ON oh.OrderID = op.OrderID
WHERE oh.DateAndTime BETWEEN '2018-05-24' AND '2019-05-24'
GROUP BY MONTH(oh.DateAndTime)
");
?>
    <center>
        <br>
        <h1>This report shows the amount of product that were sold in each month of the year.<span id="name"></span></h1><br>
        Time: 2018-05-24 To 2019-05-24<span id="name2"></span>
