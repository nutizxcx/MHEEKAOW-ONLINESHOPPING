...
$con=openCon();
$result = mysqli_query($con,"SELECT d.Reason, COUNT(d.Reason) AS Amount
FROM return_detail d JOIN return_request r ON d.ReturnID = r.ReturnID
WHERE r.DateAndTime BETWEEN '2019-05-00' AND '2019-06-00'
GROUP BY d.Reason
");
?>
    <center>
        <br>
        <h1>This report shows the amount of returning reasons in one month.<span id="name"></span></h1><br>
        Time:2019-05-00 To 2019-06-00<span id="name2"></span>
        <table id="customers">
    <thead>
      <tr>
        <th>Reason</th>
