...
$result = mysqli_query($con,"SELECT s.Size AS Size, SUM(o.Amount) AS Amount
FROM skudetail s JOIN order_product o ON s.SKU = o.SKU
JOIN order_history h ON o.OrderID = h.OrderID
WHERE h.DateAndTime BETWEEN '2019-04-24' AND '2019-05-24' 
GROUP BY s.Size
");
?>
    <center>
        <br>
        <h1>This report shows the amount of sneaker size that were sold in one month.<span id="name"></span></h1><br>
        Time: 2019-06-24 To 2019-05-24<span id="name2"></span>
