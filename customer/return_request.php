...
<form  action="return_detail.php" method="post">
  <h1 style='position:absolute; top:15.5%; left:41.5%;'>Return request</h1>
  <h4 style='position:absolute; top:22%; left:47%;'>Order ID</h4> 
  <input type="text" name="orderid" style='position:absolute; top:28%; left:41.5%; padding:5px 10px; font-size:14px; width:18%; '><br>
  <input class='orderIdBut' type="submit" style='postion:absolute; left:46%;'><br>
</form>
