<?php
  ...
  $sql = "SELECT OrderID, DateAndTime, `Status`, TrackingNumber, AddressDescribe
          FROM order_history
...
<html>
        ...
        <h1 style='position: absolute; top:11%; left:44%;'>Shipping</h1> 
        <div id='showShipping'>

        <div class="table-responsive-md" >
          <table class="table" style='width:45%; font-size:13px; position:absolute; left:3%; top:21%;'>
            <tr>
              <th>Order ID</th>
              <th>Date</th>
              <th>Address</th>
            ...
            ?>
              <tr class='recordSelect'>
                <?php echo "<td class='orderIdRecord".$i."' > ".$row['OrderID']."</td>" ?> 
                <td> <?php echo $row['DateAndTime']?> </td>
                <td> <?php echo $row['AddressDescribe']?> </td>
        ...
        <div class="table-responsive-md" >
          <table id='allProdOfId' class='table' style='font-size:13px; width:46%; position:absolute; right: 3%; top:21%;'>
            <tr>
              <th>No.</th>
              <th>Product</th>
              <th>Color</th>
        ...
        <div id='orderIsEmpty' style='margin-left:530px;'>
          <h2 >You never order from us :(</h2>
        </div>
        ...
        <div
          ...
          >
            ...
            <a href='register.html'><button class='contShopping' style='position: absolute; top:70%; left:45%;'>Shopping?</button></a>
      ...
      ></script>
        ...
        <script src="shippingHist.js"></script>
